...
export const metadata: Metadata = {
  title: "議決権行使 反対可能性分析",
  description: "投資家別ガイドライン、企業データ、候補者属性から反対可能性を論点別に表示します。",
};
    ...
    <html lang="ja">
      <body>
        <header className="border-b bg-white">
          <div className="mx-auto flex max-w-6xl items-center gap-6 px-5 py-4">
            ...
            <nav className="ml-auto flex gap-4 text-sm text-slate-600">
              <a className="hover:text-slate-950" href="/investors/blackrock">
                BlackRock
              </a>
              <a className="hover:text-slate-950" href="/investors/mufg_trust">
                三菱UFJ信託銀行
              </a>
            </nav>
          </div>
        ...
        <footer className="border-t bg-white px-5 py-4 text-center text-xs text-slate-500">
          分析支援ツールです。実際の行使判断では各投資家の最新公式資料と個別事情を確認してください。
        </footer>
      </body>
    </html>
  );
